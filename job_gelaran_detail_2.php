...
<td>
	<table>
      ...
      <tr>
        ...
        <td><span class="style3">:</span></td>
        <td class="sewing"><span class="style3"><?php echo $pabrik_sewing;?></span></td>
        <td width="150"><span class="style3"></span></td>
      ...
      <tr>
        <td><span class="style3">Kode Produksi</span></td>
        <td><span class="style3">:</span></td>
        <td class="kode_produksi"><?php echo $kode_produksi;?></td>
      </tr>
      <tr>
	...
	<table border="0" width="1000" class="border_tabel" bgcolor="#000000" cellspacing="1" cellpadding="2">
			<tr>
				...
				<th rowspan="2"><b><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="2">Supplier</font></b></th>
...
if($j==1){
	if(!$benar){
		...
		$sql="SELECT s_bahan,s_variasi FROM job_gelaran_detail_rian_detail where no_co='$no_co' and no_po='$no_po' and kode_warna='$kode_war' ";
		$res=mysql_query($sql)or die($sql);
		list($s_bahan,$s_variasi)=mysql_fetch_array($res);	
		if($s_bahan==""){
			$s_bahan="xxxx";
		}
		if($s_variasi==""){
		...
		<table width="100%">
			<tr>
				<td align="center">
					...
					<?php
						if($approved){
							?><input type="button" value="Print Mode" onclick="window.open('job_gelaran_print_2.php?no_po=<?php echo $no_po; ?>&no_co=<?php echo $no_co; ?>','job_gelaran_print','width=800,height=400,menubar=yes,scrollbars=yes');"><?php
						}
					?>
					...
					<input name="Submit" type="submit"  value="Print Lewat Excel">
