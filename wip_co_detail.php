...
<table border="0" width="1000" style="font-size: 8pt">
  ...
  <?php $sql="SELECT j.no_co,m.kode_model,j.updatedate,jc.kd_produk,s.size,su.nama,w.warna,SUM(jc.qty_produk) FROM job_gelaran_detail AS jc 
...
INNER JOIN job_gelaran AS j ON 
(jc.no_co=j.no_co)
