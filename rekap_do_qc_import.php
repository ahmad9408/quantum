<?php $content_title = "Import DO ke finish"; ?>
<?php $lihat = 1;
error_reporting(1);
...
<link rel="stylesheet" href="js/chosen_v1.5.1/chosen.min.css">
<script src="js/chosen_v1.5.1/chosen.jquery.min.js" type="text/javascript"></script>
<form method="post" action="rekap_do_qc_import_proses.php" id="f1" name="f1" enctype="multipart/form-data">
    ...
    <tr>
      <td>
        <table class="table table-bordered">
          ...
          <tr class="periode_2">
            <td><b><i>Tanggal DO </i></b></td>
            <!-- <td>:</td> -->
            <td><input type="text" name="tanggal_do" id="tanggal_do" value="<?php echo $tgl1 ?>" />
              <script language="JavaScript">
                new tcal({
                  // form name
                  'formname': 'f1',
                  // input name
                  'controlname': 'tanggal_do'
                });
              </script>
            </td>
          </tr>
          <tr>
            <td>Pabrik</td>
            <td>
              <select style="width:300px" name="pabrik" id="pabrik" class="form-control" required>
...
$sql = "SELECT id,id_import,tanggal_import,dari_bank,dari_rekening,kode_affiliator,nama_affiliator,rekening,atas_nama,bank_tujuan,
    komisi,pph,nominal_trf,tanggal_trf,posting_status,posting_date,update_user
    FROM customer_affiliate_withdraw where id_import='20220927011250' and posting_status=0";
$query = mysql_query($sql) or die('error main query');
