...
$sql="SELECT * FROM (
SELECT id,nama FROM outlet o WHERE o.jenis in (1,2) AND o.`type` in (4,1) AND o.is_show_omset=1  $sql_tbhn $sql_tambahan
UNION SELECT id,nama FROM gudang_distribusi WHERE jenis=1 $sql_tbhn ) AS a  where a.nama like '%$q%' or a.id like '%$q%' ORDER BY a.id";
