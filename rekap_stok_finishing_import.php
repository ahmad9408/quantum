...
<p></p>
<form method="post" action="rekap_so_finishing_import_proses.php" id="f1" name="f1" enctype="multipart/form-data">
    ...
    <tr>
      <td>
        <table class="table table-bordered" style="border: solid 2px #ccc">
          ...
          <tr class="periode_2">
            <td><b><i>Tanggal Stok Opname </i></b></td>
            <!-- <td>:</td> -->
