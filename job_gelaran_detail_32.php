...
real=$("#roll_bahan_real_"+warna).text();
	$("#roll_bahan_real_"+warna).html("<input type='text' name='real_roll' id='real_roll' value='"+real+"'> <input type='button' name='button' value='Ubah' onclick='simpan_real_bahan("+warna+");'>"); }else{
	
	real=$("#roll_variasi_real_"+warna).text();
	$("#roll_variasi_real_"+warna).html("<input type='text' name='variasi_roll' id='variasi_roll' value='"+real+"'> <input type='button' name='button' value='Ubah' onclick='simpan_variasi_bahan("+warna+");'>");
...
real=$("#kg_bahan_real_"+warna).text();
	$("#kg_bahan_real_"+warna).html("<input type='text' name='real_kg' id='real_kg' value='"+real+"'> <input type='button' name='button' value='Ubah' onclick='simpan_real_bahan_kg("+warna+");'>"); }else{
	
	real=$("#kg_variasi_real_"+warna).text();
	$("#kg_variasi_real_"+warna).html("<input type='text' name='variasi_kg' id='variasi_kg' value='"+real+"'> <input type='button' name='button' value='Ubah' onclick='simpan_real_variasi_kg("+warna+");'>");

}
}


function simpan_variasi_bahan(warna){
if(warna=='0'){
warna='000';
}
	var no_co=$("#no_co").text();
...
function simpan_real_bahan(warna){
...
function simpan_real_bahan_kg(warna){
...
function simpan_real_variasi_kg(warna){
...
real=$("#kode_produksi_bahan_"+warna).text();
	$("#kode_produksi_bahan_"+warna).html("<input type='text' name='kode_produksi_bahan' id='kode_produksi_bahan' value='"+real+"'> <input type='button' name='button' value='Ubah' onclick='simpan_kode_produksi_bahan("+warna+");'>"); }else{
...
<td>
	<table>
      ...
      <tr>
        ...
        <td><span class="style3">:</span></td>
        <td ><span class="c_bahan"><?php echo $c_produk?></span>&nbsp;&nbsp;&nbsp;Kg/pcs</td>
      </tr>
      <tr>
        ...
        <td><span class="style3">:</span></td>
        <td><span  class="c_variasi"><?php echo $c_variasi?></span> &nbsp;&nbsp;&nbsp;Kg/pcs</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><span class="style3">:</span></td>
        <td class="catatan"><?php echo $catatan?></td>
      </tr>
    </table>
