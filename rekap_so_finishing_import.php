...
<p></p>
<form method="post" action="rekap_so_qc_import_proses.php" id="f1" name="f1" enctype="multipart/form-data">
      ...
      <td>
        <table class="table table-bordered" style="border: solid 2px #ccc">
          ...
          <tr class="periode_2">
            ...
            <!-- <td>:</td> -->
            <td><input type="text" name="tanggal_so" id="tanggal_so" value="<?php echo $tgl1 ?>" />
