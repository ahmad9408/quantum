	...
	if (sanitasi($_POST['simpan'])){
		...
		if($jml_cutting_valid && $jml_ikatan_valid && $adarmpakai){
			...
			foreach($_POST["qtycutting"] as $barcode => $qtycutting){
				...
				$q_autocommit=mysql_query($autocommit);

				$transaction="START TRANSACTION;";
				$q_transaction=mysql_query($transaction);
				...
				$sql1="INSERT INTO job_loading_detail (no_load,seqno,kd_produk,qty_produk) VALUES ('$no_load','$seqno','$barcode','$qtycutting')";
