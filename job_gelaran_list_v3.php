...
<fieldset style="width=1%">
	...
	<form id="gelaran" name="gelaran" method="post" action="?action=search">
		<table class="table " cellpadding="0" cellspacing="0">
			<tr>
				<td width="150">No Manufaktur</td>
				<td width="2">:</td>
				<td>
					<input type="text" id="no_manufaktur" name="no_manufaktur" style="width:250px" class="form-control" onclick="showManufaktur(this.id);">

				</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
				<td><button style="width:250px" class="btn btn-success btn-block" type="button" value="Tambah CO" onclick="window.location='job_gelaran_add_v2.php?no_manufaktur='+document.getElementById('no_manufaktur').value;">Tambah CO</button></td>
			</tr>
		</table>
		...
		<table class="table ">
			...
			<tr>
				<td width="150" height="65">No PO</td>
				<td width="2">:</td>
				<td width="295"><input name="no_po" type="text" id="no_po" style="width:250px" class="form-control" value="<?php echo $no_po; ?>" /> </td>
				<td width="3">&nbsp;</td>
				<td width="150">NO CO Mapping</td>
				<td width="2">:</td>
				<td width="295" colspan="2"><input name="no_co_mapping" type="text" id="no_co_mapping" style="width:250px" class="form-control" value="<?php echo $no_co_mapping; ?>" /> </td>
				<td width="3">&nbsp;</td>
				<td>Model</td>
				<td width="2">:</td>
				<td colspan="2"><input name="model" type="text" id="model" style="width:250px" class="form-control" value="<?php echo $kode_md; ?>" /> </td>
			</tr>
			<tr>
				<td>No CO</td>
				<td width="2">:</td>
				<td> <input name="no_co" type="text" id="no_co" style="width:250px" class="form-control" value="<?php echo $no_co; ?>" /> </td>
				<td width="3">&nbsp;</td>
				<td>Identitas Kode C</td>
				<td>:</td>
				<td colspan="2"> <select id="iden" name="iden" style="width:250px" class="form-control">
						<option value="">Pilih</option>
						<option value="1" <?php if ($iden == 1) {
												echo "selected";
											} ?>>Ada</option>
						<option value="2" <?php if ($iden == 2) {
												echo "selected";
											} ?>>Belum Ada</option>
					</select>
				</td>
				...
				<td>
					<input type="text" name="awal" id="awal" style="width:200px" class="form-control" value="<?php echo $awal; ?>" /> &nbsp;
				</td>
			</tr>
			<tr>
				<td>Pabrik</td>
				<td width="2">:</td>
				<td> <input name="pabrik" type="text" id="pabrik" style="width:250px" class="form-control" value="<?php echo $pabrik; ?>" /> </td>
				<td width="3">&nbsp;</td>
				<td>Approve By</td>
				<td>:</td>
				<td colspan="2"><input type="text" id="approv" name="approv" style="width:250px" class="form-control" value="<?php echo $approv ?>" /></td>
				<td>&nbsp;</td>
				<td>Sampai</td>
				<td>:</td>
				<td width="3">
				...
				<td>
					<input type="text" name="akhir" id="akhir" style="width:200px" class="form-control" value="<?php echo $akhir; ?>" /> &nbsp;
				</td>
			</tr>
			<tr>
				<td colspan="12">&nbsp;</td>
				<td>
					<!-- <input type="submit" name="Cari" id="Cari" value="Cari Model" /> -->
					<button class="btn btn-warning btn-block" style="width:200px" type="submit" id="Cari" value="Cari Model" name="Cari">Cari Model</button></td>
				</td>
			</tr>
		</table>
	</form>
...
FROM
    ...
    LEFT JOIN `pabrik` 
		...
		`pabrik`.`nama` like '%$pabrik%'  $terusan_mapping   
		 $terusan_iden   $qtanggal $terusan_approv  $terusan_model  AND job_gelaran.no_po not like 'BTL%' AND job_gelaran.no_co  not LIKE 'BTL%' ORDER BY 
...
<table border="1" width="100%" style="font-size: 10pt" cellspacing="0" cellpadding="0" class="table_q table_q-striped table_q-hover sortable">
	<thead>
		<tr class="header_table_q">
			<td align="center" width="48" height="24"><b>No</b></td>
			<td align="center" height="24" width="160"><b>No PO Manufaktur</b></td>
			<td align="center" height="24" width="160"><b>No CO</b></td>
			<td align="center" height="24" width="160"><b>Mapping NO CO</b></td>
			<td align="center" height="24"><b>Model</b></td>
			<td align="center" height="24" width="250"><b>Pabrik</b></td>
			<td align="center" height="24" width="80"><b>Qty</b></td>
			<td align="center" height="30" width="150"><b>Tanggal</b></td>
			<td align="center" height="24"><b>Umur<br />(Hari)</b></td>
			<td align="center" height="24" width="250"><b>Approve I</b></td>
			<td align="center" height="24" width="100"><b>Real Cutting</b></td>
			<td align="center" width="87" height="24"><b>Action</b></td>
		</tr>
	</thead>
	<?php
	...
	?>
		<tr onMouseOver="this.bgColor = '#C0C0C0'" onMouseOut="this.bgColor = '<?php echo $bgcolor; ?>'" bgcolor="<?php echo $bgcolor; ?>">
			<td align="center" width="48" height="50"><?php echo $no; ?></td>
			...
			<td align="center" width="87" height="20"><a href="job_gelaran_detail_v5.php?no_po=<?php echo $no_po; ?>&no_co=<?php echo $no_co; ?>&real=<?php echo $approve2co ?>">Detil</a> <?php if ($_SESSION['username'] == "rian-it") {
																																															?>
...
<table style="margin-left:10px; margin-top:10px;">
	<tr>
		<td class="text_standard">
			Page :
			<span class="hal" onclick="location.href='job_gelaran_list_v3.php?x_idmenu=229<?php echo $tambah;  ?><?php echo $terusan ?>&hal=0';">First</span>
			<?php for ($i = 0; $i < ($jmlData[0] / $jmlHal); $i++) {
				if ($hal <= 0) { ?>
					<span class="<?php if ($i == $hal) echo "hal_select";
									else echo "hal"; ?>" onclick="location.href='job_gelaran_list_v3.php?x_idmenu=229<?php echo $tambah;  ?><?php echo $terusan ?>&hal=<?php echo $i; ?>';"><?php echo ($i + 1); ?></span>
					<?php if ($i >= 4) break;
			...
			<span class="hal" onclick="location.href='job_gelaran_list_v3.php?x_idmenu=229<?php echo $tambah;  ?><?php echo $terusan ?>&hal=<?php echo intval(($jmlData[0] / $jmlHal)); ?>';">Last</span>
			&nbsp;&nbsp;
