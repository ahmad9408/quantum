...
?>
<form method="post" action="job_qc_list.php" id="f1">
	<table border="0">
		<tr>
			<td width="120">Pencarian Model</td>
			<td width="2">:</td>
			<td><input type="text" id="cari" name="cari" size="25" value="<?php echo $cari ?>" /><input type="hidden" id="hal" name="hal" />&nbsp;&nbsp;&nbsp;
				Periode <script language="JavaScript" src="calendar_us.js"></script>
				...
				&nbsp;&nbsp;Pilihan <select id="status" name="status">
...
<table border="1" width="100%" style="font-size: 10pt" height="68" cellspacing="0" cellpadding="0" bordercolor="#ECE9D8">
	...
	$sql = "SELECT job_qc.* FROM job_qc 
			...
			(substring(jqd.kd_produk,1,7)=f.kode_model)
 			WHERE no_sew LIKE '%$no_sew' AND tanggal between '$dari 00:00:00' and '$sampai 23:59:59' and   ";
