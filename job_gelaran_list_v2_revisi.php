...
<?php
	...
	*/
	...
	// 	$awal='2023-01-01';
	// 	$akhir='2023-03-31';
	// 	$qtanggal=" `job_gelaran`.`updatedate` between '$awal 00:00:00' and '$akhir 23:59:59'";
	// 	// $qtanggal=" `job_gelaran`.`updatedate` between '2023-01-01 00:00:00' and '2023-03-31 23:59:59'";
	// }
...
WHERE $qtanggal 
ORDER BY  `job_gelaran`.`approve`, `job_gelaran`.`updatedate` DESC ";

// $sql="SELECT SQL_CACHE (`job_gelaran`.`no_co`)
//     , `job_gelaran`.`seqno`
//     , `job_gelaran`.`no_po`
//     , `job_gelaran`.`pabrik`
//     , `pabrik`.`nama`
