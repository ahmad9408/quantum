...
<?php
	...
	$sql="select pabrik.id,pabrik.nama,job_gelaran.tujuan_pabrik,job_gelaran.no_co_mapping from pabrik,job_gelaran where pabrik.id=job_gelaran.pabrik and job_gelaran.no_co='$no_co' and job_gelaran.no_po='$no_po'";
	$query=mysql_query($sql)or die($sql);
	list($id_pabrik,$pabrik,$tujuan_gudang,$mapping)=mysql_fetch_array($query);
...
<td>
	...
	<table border="0" width="1300" class="border_tabel" bgcolor="#000000" cellspacing="1" cellpadding="2">
			<tr>
				...
				<th id="supplier-border"><b><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="2">Detail Bahan Baku </font></b></th>
				<th colspan="2"><b><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="2">Variasi<br />
				(Realisasi Kg/Roll)</font></b></th>
				<th id="supplier-border" ><b><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="2">Detail Variasi </font></b></th>
			</tr>
			<tr>
