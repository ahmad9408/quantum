...
$sql = "SELECT SQL_CALC_FOUND_ROWS id_receiving,id_suratjalan,id_supplier,nama_supplier,keterangan,tgl_datang,qty,
        ...
        update_date,updateby,`status` FROM fob_receiving WHERE tgl_datang BETWEEN '$tgl1' AND '$tgl2' $pabrik2 order by tgl_datang DESC " . " limit " . ($page * $jmlHal) . "," . $jmlHal . '; -- fob_receiving.php sql1';
